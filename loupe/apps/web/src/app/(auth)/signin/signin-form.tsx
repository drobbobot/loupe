  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-warm-300 bg-white px-4 py-3 text-sm font-medium text-warm-800 transition-colors hover:bg-warm-50 active:scale-[0.99]"
      >
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-cream px-3 text-warm-400">or</span>
        </div>
      </div>
      ...
      <form onSubmit={handleEmailSignIn} className="space-y-4">
        ...
        {error && (
          <p className="text-sm text-lens-red">{error}</p>
        )}
      ...
      <p className="text-center text-sm text-warm-500">
        ...
        <Link href="/signup" className="font-medium text-warm-700 hover:text-warm-900">
          Create one
        </Link>
      </p>
    </div>
